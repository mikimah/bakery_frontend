...
import defProductImg from "../assets/defProductImg.png";
        ...
        if(!item){
            return(
                <div className="h-[90%] w-[20%] font-inter flex flex-col">
                    <img className="h-[65%] m-auto hover:scale-[1.1] duration-500 hover:cursor-pointer" src={defProductImg} alt="img san pham" />
            ...
            return(
                <div className="h-[90%] w-[20%] font-inter flex flex-col">
                    ...
                    <button onClick={() => addToCart(item.MaSP, item)} className="font-medium text-sm border-2 p-1 rounded-[5px] hover:cursor-pointer hover:text-white hover:border-amber-400 hover:bg-amber-400 duration-100">Thêm vào giỏ hàng</button>
                </div>
            );
        }
    }
